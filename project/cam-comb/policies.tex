...
\subsection{Feature-wise Linear Modulation}\label{subsec:policies-film}\todo{ref this paper arxiv1709.07871}
...
\todo{justify the reason ther are 2 layers of the lstm}
...
To investigate I created a simple feature projection network. That takes in the $7$-dimensional joint position data and learns to project it to a higher dimension, to add to the extracted view features before the final movement decision. The main benefit of this, it gives us a modular system that can be attached to any of the other systems for quick testing.
