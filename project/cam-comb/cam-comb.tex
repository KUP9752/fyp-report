\chapter{View and Feature Combination Investigations}
...
\begin{itemize}
  ...
  \todo{there are commented notes from earlier here in the contents of the chapter, check the cam-combs tex file}
