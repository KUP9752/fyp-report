...
\subsection{Experimenting with Views}\todo[color=red]{not sure what is meant to happen here, maybe move the seq trhing to grasping above and only talk about data here}
