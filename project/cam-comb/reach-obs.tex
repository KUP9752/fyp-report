...
\todo[color=red]{running right now, include and say it looks similar}
...
\todo{hint back at this in the prposed section and about how keeping some together while others are connected might make the most sense. like wd and lr combo makes the most sense}