...
\missingfigure{add the task images from ReachObs\_Random IndRandom}
...
Another task which is likely to suffer from lack of viewpoints is a grasping task. Although, in a more nuanced way compared to the reaching with obstacles. \todo{Grasp style Simple and OTher}
